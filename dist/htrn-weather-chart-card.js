...
class HTRNWeatherChartCard extends s {
      ...
      datalabels: {
        ...
        formatter: (value, context) => {
          ...
          const rainfall = this.convertDistance(
            ...
            inputPrecipUnit,
            outputPrecipUnit);
          return `${rainfall} ${this.ll('units')[outputPrecipUnit]}`;
        },
      },
  ...
  renderAttributes({ config, sun, language, option1, option2, option3 } = this) {
    ...
    <div class="attributes">
      ${(humidity !== undefined || pressure !== undefined || dew_point !== undefined || visibility !== undefined) ? x`
        <div>
          ${humidity !== undefined ? x`
            <ha-icon icon="hass:water-percent"></ha-icon> ${humidity} %<br>
          ` : ''}
          ${pressure !== undefined ? x`
      ...
      ` : ''}
      ${((showSun && sun !== undefined) || uv_index !== undefined) ? x`
        <div>
          ${uv_index !== undefined ? x`
            <div>
      ...
      ` : ''}
      ${(wind_bearing !== undefined || wind_speed !== undefined) ? x`
        <div>
          ${wind_bearing !== undefined ? x`
            <ha-icon icon="hass:${this.getWindDirIcon(wind_bearing)}"></ha-icon> ${this.getWindDir(wind_bearing)} <br>
          ` : ''}
          ${wind_speed !== undefined ? x`
            <ha-icon icon="hass:weather-windy"></ha-icon>
            ${wind_speed} <br>
          ` : ''}
          ${wind_gust_speed !== undefined ? x`
...
`;
  ...
  renderWindForecast({ config, forecastItems } = this) {
    ...
    return x`
      <div class="wind-details">${forecast.map(item => x`
