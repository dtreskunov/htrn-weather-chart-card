...
class HTRNWeatherChartCard extends s {
  ...
  renderAttributes({ config, humidity, windDirection, sun, language, uv_index, dew_point, wind_gust_speed, visibility, option1, option2, option3 } = this) {
    ...
    <div class="attributes">
      ${((showHumidity && humidity !== undefined) || pressure !== undefined || (showDewpoint && dew_point !== undefined) || (showVisibility && visibility !== undefined)) ? x`
        <div>
      ...
      ` : ''}
      ${((showWindDirection && windDirection !== undefined) || windSpeed !== undefined) ? x`
        <div>
